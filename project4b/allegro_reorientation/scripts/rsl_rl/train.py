...
from allegro_reorientation.assets.robots.allegro import apply_allegro_hand_preset

# import logger
logger = logging.getLogger(__name__)

import allegro_reorientation.tasks  # noqa: F401
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    if hasattr(env_cfg, "hand_preset"):
        ...
        if not agent_cfg.experiment_name.endswith(f"_{args_cli.hand_preset}"):
            agent_cfg.experiment_name = f"{agent_cfg.experiment_name}_{args_cli.hand_preset}"
