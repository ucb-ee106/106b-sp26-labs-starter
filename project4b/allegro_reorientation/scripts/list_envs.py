...
All the environments are registered in the `allegro_reorientation` extension. They start
...
def main():
    """Print all environments registered in `allegro_reorientation` extension."""
